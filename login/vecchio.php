...
<head>
  ...
  <!-- Favicons -->
  <link href="http://badmintonclubs.altervista.org/img/volano.png" rel="icon">
  ...
  <!-- =======================================================
    Theme Name: BadmintonClubs
    Theme URL: badmintonclubs.altervista.org
    Author: Bissessur Marco
  ======================================================= -->
</head>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Badminton Clubs</a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          // $risultati = mysql_query($connection,$query); 
          $nome = mysql_result($risultati, "name");
          echo'name';
